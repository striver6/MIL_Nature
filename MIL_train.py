...
parser.add_argument('--train_lib', type=str, default=r'D:\Camp\train_lib\data.pt', help='path to train MIL library binary')
parser.add_argument('--val_lib', type=str, default=r'D:\Camp\val_lib\valdata.pt', help='path to validation MIL library binary. If present.')
parser.add_argument('--output', type=str, default=r'D:\Camp\output', help='name of output file')
...
parser.add_argument('--batch_size', type=int, default=4, help='mini-batch size (default: 512)')
...
def inference(run, loader, model):
    ...
    print("loader:",loader)
    print("loader.dataset:",loader.dataset)
    print("probs:",probs)
...
class MILdataset(data.Dataset):
    def __init__(self, libraryfile='', transform=None):
        ...
        for i,name in enumerate(lib['slides']):
            ...
            # slides.append(cv2.imread(name))
            # print(cv2.imread(name))
            # to open a tiff file for reading:
            # slides.append(TIFF.open(name, mode='r'))
