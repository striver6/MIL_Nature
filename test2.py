...
sys.path.append('D:/CAMELYON16/testing/images1')
...
data_base_dir = "D:/CAMELYON16/testing/images"  # 存放原始图片地址
save_dir = "D:/CAMELYON16/testing/images2"  # 保存生成图片地址
# 存放图片名及目标区域(x,y,w,h)的txt文件地址
# 形如：000001.tif 87 90 126 160,下面只需要用到图片名，也可不写目标区域(x,y,w,h)
read_file_name_rect = "D:/CAMELYON16/testing/images/dir.txt"
